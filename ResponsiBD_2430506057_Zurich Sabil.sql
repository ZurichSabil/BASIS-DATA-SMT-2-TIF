...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Mar 2025 pada 04.47
...
('A001', 'Rizky Ridho', 'Informatika', '2025-01-01'),
('A002', 'Indra Yuhanif', 'Teknologi Informasi', '2025-03-10'),
('A003', 'Akbar Mukti', 'Teknik Elektro', '2025-03-09');
...
('B001', 'Pemrograman Dasar', 'IT konsul', 2020, NULL),
('B002', 'Basis Data', 'Databases', 2020, NULL),
('B003', 'Jaringan Komputer', 'Pustaka Teknologi', 2021, NULL),
('B004', 'Struktur Data', 'Pusat Data', 2021, NULL),
('B005', 'Keamanan Digital', 'Sumber AI', 2022, NULL);
...
INSERT INTO `peminjaman` (`id_peminjaman`, `id_anggota`, `id_buku`, `tgl_pinjam`, `tgl_kembali`, `jumlah_denda`) VALUES
(4, 'A001', 'B001', '2025-03-15', '2025-03-19', 0),
(5, 'A002', 'B002', '2025-03-13', '2025-03-18', 0),
(6, 'A003', 'B003', '2025-03-16', NULL, 0);
